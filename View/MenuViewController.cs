       ...
       // private MenuItem ServersItem;
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                this.enableItem = CreateMenuItem("连接远程服务器", new EventHandler(this.EnableItem_Click)),
      ...
      /*  private void UpdateServersMenu()
        ...
        */
        ...
        private void ShowFirstTimeBalloon()
        {
            if (_isFirstRun)
            {
                _notifyIcon.BalloonTipTitle = I18N.GetString("点击这里，开始翻墙！");
                _notifyIcon.BalloonTipText =  I18N.GetString("右击托盘图标，选择 连接远程服务器 即可 翻墙.");
